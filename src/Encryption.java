...
public class Encryption {
	...
	static char[][] mixedUps = {
			...
			{ 'j', '4', 'd', 'i', '7', '5', 'p', 'o', 'v', 'q', 'b', '9', 't', '/', 'k', 'm', 'w', '8', 'c', ',', 's',
					...
					'1', ':', 'l', ';', 'g', '2', '0', '=' } };
	static int[] randomLevels = { 71, 51, 26, 66, 50, 20, 49, 34 };
	static String[] levelKeys = { "k5", ";k", "/p", "&l", "!u", "ff", "!6", "5=" };
	static char[] charsToUse = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's',
			't', 'u', 'v', 'w', 'x', 'y', 'z', ',', '.', '?', '&', '%', '!', '1', '2', '3', '4', '5', '6', '7', '8',
			'9', '0', '/', ':', ';', '=', '<', '>', '#' };
	
	//generates a new set of keys to be copied back into the code
	static String reprogram() {
	...
	static String addCipher(String message) {
		...
		for (int i = 0; i < inString.toCharArray().length; i++) {
			...
			if (currentChar != ' ') {
				...
				// like '?'
				outString += keyToUse[findInArray(charsToUse, currentChar)];
			} else {
	...
	static String removeCipher(String in) {
		String out = "";
	...
	static String de_encrypt(String message) throws IndexOutOfBoundsException {
		String temp = message;
	...
	static String encrypt(String message) {
		...
		return levelKeys[levelSelectedIndex] + temp;
	}
	...
	static int findInArray(char[] array, char value) {
		for (int i = 0; i < array.length; i++) {
			if (array[i] == value) {
				return i;
			}
